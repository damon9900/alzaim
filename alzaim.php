...
ob_start();
error_reporting(0);
define('API_KEY','6099950788:AAHEcrJvPbP8sQ6P3pFxzo6sDfCgLE6tJh0');
...
$Dev = array("5662617561","5662617561","5662617561"); //ID ADMIN NUMBER 1 HE CHAT
@$usernamebot = "pro_0i0_bot"; //UserName Bot
@$channel = "smjoj"; // UserName Channel don't @
@$token = API_KEY;
...
'inline_keyboard'=>[
[
['text'=>"تابع جديدنا",'url'=>"https://t.me/smjoj"],['text'=>"$dataadd",'callback_data'=>"text"]
],
]
])
]); 
...
'inline_keyboard'=>[
 	[
['text'=>"📢 تابع جديدنا 📢",'url'=>"https://t.me/smjoj"]
  ],
   ]
   ])
 ]); 
